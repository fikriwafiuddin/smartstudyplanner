    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-primary p-12 flex-col justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Smart Study</h1>
            <p className="text-sm text-white/80">Planner</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-white/80 max-w-md">
            Join thousands of students who use Smart Study Planner to manage
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-8 animate-slide-up">
          ...
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">Smart Study</h1>
